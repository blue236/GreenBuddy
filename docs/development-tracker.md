...
- companion continuity-lead and real-plant summary fallback assembly were also consolidated into dedicated helper functions in `CompanionChatModels.kt` without changing behavior
...
- continue small helper cleanups for remaining inline companion fallback blocks such as relationship lines and mission/growth/weather reply paths where safe
