...
- continue small helper cleanups for remaining inline companion fallback blocks such as continuity, real-plant summary, relationship lines, and mission/growth/weather reply paths where safe
