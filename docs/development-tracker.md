...
- companion continuity-lead, real-plant summary, relationship, mission/growth/weather reply, and casual reply fallback assembly were also consolidated into dedicated helper functions in `CompanionChatModels.kt` without changing behavior
...
- reassess whether any remaining inline companion fallback cleanup still has enough ROI before continuing this consolidation streak
