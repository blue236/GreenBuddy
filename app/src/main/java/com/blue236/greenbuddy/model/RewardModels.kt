...
data class RewardState(
    ...
    fun rewardForDailyMissionCompletion(): RewardState = copy(
        leafTokens = leafTokens + DailyMissionSet.DAILY_REWARD_TOKENS,
    )

    fun rewardForStreakBonus(): RewardState = copy(
        leafTokens = leafTokens + DailyMissionSet.STREAK_REWARD_TOKENS,
    )
