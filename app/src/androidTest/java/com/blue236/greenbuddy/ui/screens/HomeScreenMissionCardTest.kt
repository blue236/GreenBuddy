...
class HomeScreenMissionCardTest {
    ...
    @Test
    fun todaysLessonCard_showsPrimaryLessonCtaNearTop() {
        ...
        composeTestRule.onNodeWithText(activity.getString(R.string.todays_lesson)).assertIsDisplayed()
        composeTestRule.onNodeWithText(lessons.first().title).assertIsDisplayed()
        composeTestRule.onNodeWithText(activity.getString(R.string.home_best_action_cta_lesson)).assertIsDisplayed()
    }
